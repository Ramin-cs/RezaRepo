#!/usr/bin/env python3
"""
SCAN_ME.py - Open Redirect Scanner
...
def print_usage():
    ...
    print("""
    Usage: python SCAN_ME.py <target_url> [options]
    
    Examples:
        python SCAN_ME.py https://target-website.com
        python SCAN_ME.py https://target-website.com --output results --threads 20
        python SCAN_ME.py https://target-website.com --preset thorough
...
def show_usage_examples():
    ...
    print("1. Basic scan:")
    print("   python SCAN_ME.py https://target-website.com")
    
    print("\n2. Advanced scan:")
    print("   python SCAN_ME.py https://target-website.com --output results --threads 20 --depth 3")
    
    print("\n3. Using presets:")
    print("   python SCAN_ME.py --preset thorough https://target-website.com")
    print("   python SCAN_ME.py --preset stealth https://target-website.com")
    print("   python SCAN_ME.py --preset debug https://target-website.com")
    
    print("\n4. Test functionality:")
    print("   python SCAN_ME.py --test")
    
    print("\n5. Show capabilities:")
    print("   python SCAN_ME.py --capabilities")
