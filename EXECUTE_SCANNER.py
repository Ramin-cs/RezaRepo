#!/usr/bin/env python3
"""
EXECUTE_SCANNER.py - Open Redirect Scanner
...
def print_usage():
    ...
    print("""
    Usage: python EXECUTE_SCANNER.py <target_url> [options]
    
    Examples:
        python EXECUTE_SCANNER.py https://target-website.com
        python EXECUTE_SCANNER.py https://target-website.com --output results --threads 20
        python EXECUTE_SCANNER.py https://target-website.com --preset thorough
...
def show_usage_examples():
    ...
    print("1. Basic scan:")
    print("   python EXECUTE_SCANNER.py https://target-website.com")
    
    print("\n2. Advanced scan:")
    print("   python EXECUTE_SCANNER.py https://target-website.com --output results --threads 20 --depth 3")
    
    print("\n3. Using presets:")
    print("   python EXECUTE_SCANNER.py --preset thorough https://target-website.com")
    print("   python EXECUTE_SCANNER.py --preset stealth https://target-website.com")
    print("   python EXECUTE_SCANNER.py --preset debug https://target-website.com")
    
    print("\n4. Test functionality:")
    print("   python EXECUTE_SCANNER.py --test")
    
    print("\n5. Show capabilities:")
    print("   python EXECUTE_SCANNER.py --capabilities")
