...
def print_usage():
    ...
    print("""
    Usage: python run_final.py <target_url> [options]
    
    Examples:
        python run_final.py https://target-website.com
        python run_final.py https://target-website.com --output results --threads 20
        python run_final.py https://target-website.com --preset thorough
...
def show_usage_examples():
    ...
    print("\n2. Advanced scan:")
    print("   python main.py https://target-website.com -o results -j 20 -d 3")
    
    print("\n3. Using presets:")
    print("   python main.py --preset thorough https://target-website.com")
    print("   python main.py --preset stealth https://target-website.com")
    print("   python main.py --preset debug https://target-website.com")
    
    print("\n4. Using configuration file:")
    print("   python main.py -c config.json")
    
    print("\n5. Using run script:")
    print("   ./run.sh https://target-website.com")
    print("   ./run.sh --preset thorough https://target-website.com")
    
    print("\n6. Using Docker:")
    print("   docker build -t open-redirect-scanner .")
    print("   docker run --rm -v $(pwd)/results:/app/scan_results open-redirect-scanner https://target-website.com")
