#!/usr/bin/env python3
"""
RUN_ME.py - Open Redirect Scanner
...
def print_usage():
    ...
    print("""
    Usage: python RUN_ME.py <target_url> [options]
    
    Examples:
        python RUN_ME.py https://target-website.com
        python RUN_ME.py https://target-website.com --output results --threads 20
        python RUN_ME.py https://target-website.com --preset thorough
...
def show_usage_examples():
    ...
    print("1. Basic scan:")
    print("   python RUN_ME.py https://target-website.com")
    
    print("\n2. Advanced scan:")
    print("   python RUN_ME.py https://target-website.com --output results --threads 20 --depth 3")
    
    print("\n3. Using presets:")
    print("   python RUN_ME.py --preset thorough https://target-website.com")
    print("   python RUN_ME.py --preset stealth https://target-website.com")
    print("   python RUN_ME.py --preset debug https://target-website.com")
    
    print("\n4. Test functionality:")
    print("   python RUN_ME.py --test")
    
    print("\n5. Show capabilities:")
    print("   python RUN_ME.py --capabilities")
