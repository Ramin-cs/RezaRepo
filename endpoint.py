...
def banner():
    ...
    try:
        print(f"""{C.CYAN}
 ____  _                                   __  __           _            
|  _ \\(_)___  ___ _____   _____ _ __ _   _ |  \\/  | __ _ ___| |_ ___ _ __ 
| | | | / __|/ __/ _ \\ \\ / / _ \\ '__| | | || |\\/| |/ _` / __| __/ _ \\ '__|
| |_| | \\__ \\ (_| (_) \\ V /  __/ |  | |_| || |  | | (_| \\__ \\ ||  __/ |   
|____/|_|___/\\___\\___/ \\_/ \\___|_|   \\__, ||_|  |_|\\__,_|___/\\__\\___|_|   
                                     |___/                               
...
|_|  |_|\\__,_|___/\\__\\___|_|   
    ...
    """, flush=True)
        ...
        print("Discovery Master - Ultimate Directory/File/Content Discovery Tool")
    except Exception:
        print("Discovery Master - Ultimate Directory/File/Content Discovery Tool")
