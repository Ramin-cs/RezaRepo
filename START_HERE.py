#!/usr/bin/env python3
"""
START_HERE.py - Open Redirect Scanner
...
def print_usage():
    ...
    print("""
    Usage: python START_HERE.py <target_url> [options]
    
    Examples:
        python START_HERE.py https://target-website.com
        python START_HERE.py https://target-website.com --output results --threads 20
        python START_HERE.py https://target-website.com --preset thorough
...
def show_usage_examples():
    ...
    print("1. Basic scan:")
    print("   python START_HERE.py https://target-website.com")
    
    print("\n2. Advanced scan:")
    print("   python START_HERE.py https://target-website.com --output results --threads 20 --depth 3")
    
    print("\n3. Using presets:")
    print("   python START_HERE.py --preset thorough https://target-website.com")
    print("   python START_HERE.py --preset stealth https://target-website.com")
    print("   python START_HERE.py --preset debug https://target-website.com")
    
    print("\n4. Test functionality:")
    print("   python START_HERE.py --test")
    
    print("\n5. Show capabilities:")
    print("   python START_HERE.py --capabilities")
